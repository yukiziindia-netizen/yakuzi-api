...
export class CreatePaymentDto {
  ...
  @ApiProperty({ example: 1500.5, description: 'Payment amount' })
  ...
  @ApiProperty({
    enum: ['BANK_TRANSFER', 'UPI', 'CASH_ON_DELIVERY', 'CHEQUE'],
    example: 'UPI',
  })
  ...
  @ApiPropertyOptional({
    example: 'UPI-REF-789012',
    description: 'Bank/UPI reference number',
  })
  @IsString()
  @IsOptional()
